...
<html>
  <head>
    ...
    <title>My JSP 'currencies.jsp' starting page</title>
  ...
  <body>
	...
	<div class="modal-footer" style="text-align: left;">
		<span class="">货币名称</span><input type="text" id="search" value="${searchStr}" style="height:25px;" class=""/>
	...
	function showImport(){
	  	var url = "${pageContext.request.contextPath}/pages/import/currimport.jsp";
	  	toMain(url);
  	}
</script>