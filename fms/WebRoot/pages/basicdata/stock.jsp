...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/public/public.js"></script>
  ...
  <div class="row-fluid" >
			...
			<div class="row-fluid">
				<div class="span12">
					<table id="sample-table-1" class="table table-striped table-bordered table-hover"  style=" font-size: 12px;">
						...
						<tbody>
							<c:forEach var="stock" items="${stocks}" varStatus="index" step="1">
								<tr>
									<td class="center" style="width:30px;" ><!-- .checkbox input[type="checkbox"] -->
										<input type="checkbox" value="${stock.id}" name="sid" style="width:30px;"/>
									</td>
	...
	function gotoPage(pageNum, pageSize) {
		...
		// 拼接URL
		var url = "${pageContext.request.contextPath}/stock_findAllStock.action?currIndex=" + pageNum + "&maxIndex="+ pageSize + "&searchStr="+parse(likeStr);
		// 在本窗口中显示指定URL的页面
		toMain(url);
	}
