...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/public/public.js"></script>
	...
	<div class="modal-footer" style="text-align: left;">
		<span class="">单位名称</span><input type="text" id="search" value="${searchStr}" style="height:25px;" class=""/>
  ...
  <div class="row-fluid" >
		<div class="span12">
			...
			<div class="row-fluid">
				<div class="span12">
					<table id="sample-table-1" class="table table-striped table-bordered table-hover"  style=" font-size: 12px;">
						...
						<tbody>
							<c:forEach var="unit" items="${units}" varStatus="index" step="1">
								<tr>
									<td class="center" style="width:30px;" ><!-- .checkbox input[type="checkbox"] -->
										<input type="checkbox" value="${unit.id}" name="sid" style="width:30px;"/>
									</td>

									<td class="center"><a href="#">${index.index+1}</a>
									</td>
									<td class="center">${unit.code}　</td>
									<td class="center">${unit.name}　</td>
									<td class="hidden-480 center">${unit.note}　</td>
									<td class="center">
										<a href="javascript:void(0);" onclick="toedit('${unit.id}')">修改</a>｜
										<a href="javascript:void(0);" onclick="delData('${unit.id}','Unit')">删除</a>
									</td>
								</tr>
							</c:forEach>
					</table>
			...
			<div class="modal-footer">
				<button class="btn btn-small btn-danger pull-left" data-toggle="button" type="button" onclick="toMain('${pageContext.request.contextPath}/pages/basicdata/addunit.jsp');">新增</button>
